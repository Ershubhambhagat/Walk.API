...
Values ('abb1561a-b9e9-4e1b-b89c-362c14c24ff1', 'readonly@user.com', 'readonly@user.com');

Insert into Users( Id, Name,Email , Password)
Values ('ebad0f8c-aa01-4c06-8467-d5a892fe212f', 'readwrite@user.com', 'readwrite@user.com');
